...
export const ADMIN_COOKIE = "ved_admin_session";
const SESSION_DAYS = 7;

export function getAdminPassword(): string {
  return process.env.ADMIN_PASSWORD || "ved2026";
}
...
function getSecret(): string {
  return process.env.ADMIN_SESSION_SECRET || `ved-admin-secret::${getAdminPassword()}`;
}
